...
public class BCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bitmap = CreateDCode.withIcon(bitmap, Utils.readBitMap(BCodeActivity.this, R.mipmap.ic_launcher), 0.2f);
    ...
    private void ref() {
        imageView.setImageBitmap(CreateDCode.CreateQRCodePolygon(cev, 1000, nem));
    }
}
